...
import pyrdw.core.resetter.extend as reset_extend
...
def __obtain_rdw_manager(rdwer='no'):
    ...
    if rdwer == 'no':
        ...
        tar_rdw = rdw_react.ARCRdwManager()
    elif rdwer == 'apfs2t':
        tar_rdw = rdw_react.APFS2TRdwManager()
...
def __obtain_reset_manager(resetter='r21'):
    ...
    if 'r21' == resetter:
        ...
        tar_reset = reset_extend.TurnRegionWeightGradResetter()
    elif 'r2rc' == resetter:
        tar_reset = reset_extend.TurnRegionCenterResetter()
    elif 'r2mrc' == resetter:
        tar_reset = reset_extend.TurnMaxRegionCrossResetter()
    elif 'r2mpe' == resetter:
        tar_reset = reset_extend.TurnMaxProbEnergyResetter()
    elif 'apfs2t' == resetter:
        tar_reset = reset_extend.TurnAPFS2TResetter()
